...
- **E2E (Playwright)** :
  ```bash
  playwright install
  pytest -q playwright_tests/
  ```
- Configurez GitHub Actions via `.github/workflows/python.yml` (exemple inclus)

---

## 9. Contribution et maintenance

1. **Fork** puis **clone** si vous contribuez
2. **Créez** une branche pour chaque fonctionnalité ou correction
3. **Commit** avec message clair (`feat:`, `fix:`, `chore:`)
4. **Push** puis **Pull Request** vers `main`

---

> **À retenir** :
>
> - Les dossiers `models/`, `chroma_db/`, `.venv/` ne sont **pas** versionnés.
> - Tout nouveau collaborateur clone, crée son venv, installe les dépendances, télécharge le modèle, ingère ses documents, et lance l'app.
